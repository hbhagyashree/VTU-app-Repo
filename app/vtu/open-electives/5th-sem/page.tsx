...
export const metadata: Metadata = {
  title: 'VTU 5th Sem Open Elective PYQs, Notes and Syllabus – 2022 Scheme',
  description:
    'VTU 5th semester open elective subjects with syllabus, notes, PYQs, important questions and exam preparation materials for 2022 scheme. Content coming soon.',
};

const semesterTabs = [
  { label: '5th Sem Open Electives', href: '/vtu/open-electives/5th-sem', active: true },
...
export default function OpenElectives5thSemPage() {
  return (
    <AppShell>
      <div className="flex flex-col gap-8">
        <nav className="flex items-center gap-2 text-sm text-slate-500" aria-label="Breadcrumb">
          ...
          <span aria-hidden="true">/</span>
          <span className="text-slate-300">5th Sem</span>
        </nav>
        ...
        <header className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-slate-900/70 p-8">
          ...
          <div className="relative">
            ...
            <p className="mt-3 max-w-2xl text-slate-300 leading-7">
              Syllabus, notes, PYQs, and important questions for all VTU 5th semester open elective subjects — 2022 scheme.
            </p>
          </div>
        </header>
        ...
        <div className="flex flex-col items-center gap-6 rounded-3xl border border-dashed border-white/10 bg-slate-900/50 py-20 text-center">
          <p className="text-slate-300 font-semibold">5th Sem Open Electives — Coming Soon</p>
          <p className="max-w-md text-sm text-slate-400">
            Subjects for 5th semester open electives are being added. Check the 6th semester section which is already available.
          </p>
          <Link
